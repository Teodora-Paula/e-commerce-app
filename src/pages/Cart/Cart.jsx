                            ...
                            this.props.products?.map(product => {
                                return <div className="d-flex justify-content-between align-items-center text-center" key={product.id}>
                                    ...
                                    <div className="w-25 d-flex justify-content-center">
                                        ...
                                        <div onClick={() => this.props.removeFromCart({id: product.id})}>
                                            <Close />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex justify-content-end border-top">
                            ...
                            <div className="w-25">
                                <p className="my-4 text-center">
                                    { this.totalSum(this.props.products) } { this.props.products[0].currency }
                                </p>
                            </div>
                        </div>
                        <div className="container-min-max-width d-flex justify-content-end">
                                <button className="btn w-25 btn-success mw-6"
                                    onClick={()=>{
                                        ...
                                        //     };
                                        // }
                                        // if(!initial[this.props.user.data.email]){
                                        //     initial[this.props.user.data.email]=[];
                                        // }
                                        //     let date=new Date();
                                        //     date=date.toDateString();

                                        //     initial[this.props.user.data.email].push({products:this.props.products,
                                        //     date:date})
